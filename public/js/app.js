...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    chooseSomeone: function chooseSomeone(id) {
      var _this = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("http://localhost:8000/api/participant/submit", {
        ...
        _this.refresh_participant();
      });
    },
    refresh_list: function refresh_list() {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://localhost:8000/api/participants/all").then(function (response) {
        response.data.data = response.data.data.map(function (participant) {
          participant.url = "http://localhost:8000/60/" + participant.url;
          return participant;
        });
        _this2.all_participants = response.data.data;
      });
    },
    refresh_participant: function refresh_participant() {
      var _this3 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://localhost:8000/api/participant").then(function (response) {
        response.data.data = response.data.data.map(function (participant) {
          participant.url = "http://localhost:8000/image/" + participant.url;
          return participant;
        });
        _this3.participant = response.data.data;
      });
    }
  },
...
var render = function() {
  ...
  return _c("div", { staticClass: "row no-gutters" }, [
    _c("div", { staticClass: "main-wrapper col-md-9" }, [
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "body-wrapper" }, [
          ...
          _vm.participant[0]
            ? _c("div", { staticClass: "col-md-5 text-center" }, [
                _c("div", { staticClass: "img-container" }, [
                  _c("img", {
                    staticClass: "image",
                    staticStyle: { border: "2px solid #000" },
                    attrs: { src: _vm.participant[0].url }
                  }),
                  _vm._v(" "),
            ...
            ? _c("div", { staticClass: "col-md-5 text-center" }, [
                _c("div", { staticClass: "img-container" }, [
                  _c("img", {
                    staticClass: "image",
                    staticStyle: { border: "2px solid #000" },
                    attrs: { src: _vm.participant[1].url }
                  }),
                  _vm._v(" "),
                  _c("div", { staticClass: "overlay" }, [
                    _c("div", { staticClass: "text" }, [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "mean-header text-center" }, [
          _vm._v("Who is Hotter? Give her a Heart")
        ])
      ])
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "side col-md-3" }, [
      _c("div", { staticClass: "mean-header p-3 text-center" }, [
        _vm._v("HOT, HOTTER, HOTTEST")
      ]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "alert-container mt-1" },
        _vm._l(_vm.all_participants, function(item, index) {
          return _c(
            "div",
            {
              key: index,
              staticClass: "alert alert-danger ml-2 mr-2",
              attrs: { role: "alert" }
            },
            [
              _c("div", [
                _c("img", {
                  ...
                  attrs: { src: item.url, height: "40px", width: "40px;" }
                }),
                _vm._v(" "),
                ...
                _vm._v(" "),
                _c("span", { staticClass: "float-right pt-2" }, [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "wrapper pt-5 mt-4" }, [
      _c("div", { staticClass: "header text-center" }, [_vm._v("FACEMASH")]),
      _vm._v(" "),
      _c("div", { staticClass: "sub-header text-center" }, [
        _vm._v(
...
__webpack_require__(/*! /home/sam/Documents/projects/facemash/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/sam/Documents/projects/facemash/resources/sass/app.scss */"./resources/sass/app.scss");
